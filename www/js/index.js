...
const domainUrl = "http://10.0.2.2:3000";  // if local test, pls use this 
...
$(document).ready(function () {
	...
	**/
	...
	$('#loginButton').click(async function (e) {
		...
		try {
			...
			const response = await fetch('http://10.0.2.2:3000/verifyUser', {
				method: 'POST',
				headers: {
	...
	$('#confirmOrderButton').click(async function (e) {
		...
		if ($("#orderForm").valid()) {
			...
			try {
				...
				const response = await fetch('http://10.0.2.2:3000/postOrderData', {
					method: 'POST',
					headers: {
						'Content-Type': 'application/json',
					},
	...
	**/
	...
	$('#SubmitSignUp').click(async function (e) {
		...
		if ($("#SignupForm").valid()) {
			...
			try {
				const response = await fetch('http://10.0.2.2:3000/registerUser', {
					method: 'POST',
					headers: {
						'Content-Type': 'application/json',
					},
	...
	**/
	...
	$(document).on("pagebeforeshow", "#pastOrdersPage", async function () {
		...
		try {
			const response = await fetch('http://10.0.2.2:3000/getUserOrders', {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json',
				},
	...
	**/
	...
	$('#deleteSelectedOrdersButton').click(async function () {
		...
		try {
			const response = await fetch('http://10.0.2.2:3000/deleteSelectedOrders', {
				method: 'DELETE',
				headers: {
					'Content-Type': 'application/json',
				},
